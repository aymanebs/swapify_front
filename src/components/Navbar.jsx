...
export const Navbar = () => {
  ...
  const [notificationsList, setNotificationsList] = useState([]); // Store all notifications
                    ...
                    <div className="absolute right-0 mt-2 w-64 bg-white rounded-xl shadow-xl py-2 z-50 border border-gray-100 overflow-hidden transition-all duration-300 animate-fadeIn">
                      ...
                      <ul className="py-1">
                        <li>
                          <Link
                            to="/profile"
                            className="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-sky-50 transition-all duration-200"
                          >
