...
function ContactHero() {
  return (
    <div className="relative h-[80vh] w-full overflow-hidden">
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-r from-sky-500/90 via-sky-700/80 to-transparent w-full" />
      ...
      <div className="relative h-full w-full px-4 sm:px-6 lg:px-8 flex items-center">
        <div className="max-w-2xl">
          ...
          <div className="flex items-center gap-4 text-sky-50">
      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16">
        <div>
          ...
          <form className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-sky-600 text-white px-8 py-3 rounded-lg hover:bg-sky-700 transition-colors"
            >
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="tel:+1234567890" className="text-sky-600 hover:text-sky-700">
                    +1 (234) 567-890
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:contact@example.com" className="text-sky-600 hover:text-sky-700">
                    contact@example.com
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sky-600">123 Sample Street, City, Country</p>
                </div>
              </div>
            </div>
          </div>
