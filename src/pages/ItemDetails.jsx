        ...
        <div className="space-y-8">
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <button className="w-full py-4 px-6 bg-emerald-600 text-emerald-50 font-medium rounded-xl hover:bg-emerald-700 transition-all duration-300 transform hover:translate-y-[-2px] hover:shadow-lg">
                Propose Swap
              </button>
            </div>
          </div>
